+++
title = "Riverside Commuter: Rigid Fork Swap"
date = "2026-03-29"
description = "Upgrading a Decathlon Riverside hybrid with a TOSEEK carbon rigid fork — ditching the heavy suspension for a lighter, stiffer commute."
...
{{< figure src="/riverside-upgrade/pannier-night.png" caption="Evening commuter setup. Roll-top waterproof pannier on the rear rack, bottle cage on the down tube, and a saddle bag for tools." >}}

{{< figure src="/riverside-upgrade/rear-view.png" caption="Rear view showing the pannier bag, bungee cord securing the load, and the kickstand deployed for quick stops." >}}

{{< figure src="/riverside-upgrade/commuter-loadout.png" caption="Full daily loadout — rear LED light, reflective pannier patch, and the B'Twin Trekking Speed 700×38C tires that handle everything from tarmac to park connectors." >}}
...
{{< figure src="/riverside-upgrade/toseek-fork.png" caption="The TOSEEK rigid fork — matte carbon finish, post-mount disc brake tab, and an expander plug for the carbon steerer." >}}

{{< figure src="/riverside-upgrade/toseek-specs.png" caption="Technical drawing showing the 470mm axle-to-crown (29\"), 28.6mm steerer, 100mm hub spacing, and 45mm rake." >}}
