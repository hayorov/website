+++
title = "Riverside Commuter: Shimano CUES Drivetrain Swap"
date = "2026-04-14"
description = "Part two of the Riverside upgrade — replacing the stock B'Twin square-taper crankset and bottom bracket with a Shimano CUES 1x setup for smoother shifting and a cleaner chainline."
tags = ["cycling", "gear", "diy"]
draft = false
+++

In [Part 1](/posts/riverside-commuter-rigid-fork-swap/) I swapped the heavy Zoom suspension fork for a TOSEEK carbon rigid. That shaved over a kilogram off the front end and transformed the steering. Naturally, once you fix one thing, the next weak link becomes impossible to ignore — and on the Riverside that was the drivetrain.

{{< figure src="/riverside-upgrade/stock-drivetrain.jpg" caption="The stock drivetrain — B'Twin square-taper crankset with plastic chain guard, 11-36T cassette, and the original bottom bracket. Functional, but nothing more." >}}
...
{{< figure src="/riverside-upgrade/shimano-cues-parts.jpg" caption="Shimano CUES crankset and Hollowtech II bottom bracket — still in factory wrapping. The 32T chainring with Dynamic Chain Engagement+ and external bearing cups with orange seals." >}}
...
{{< figure src="/riverside-upgrade/old-crankset-removed.jpg" caption="The old B'Twin crankset and square-taper cartridge bottom bracket laid out after removal. The crank bolts, chainring, and plastic guard all come off as one unit." >}}

{{< figure src="/riverside-upgrade/bb-shell-empty.jpg" caption="Bottom bracket shell cleaned and ready. Internal threads are in good shape — no corrosion or cross-threading. Cable guide bolted underneath routes the derailleur cables." >}}
...
{{< figure src="/riverside-upgrade/bb-greased.jpg" caption="Drive-side bottom bracket cup installed with fresh green grease on the bearing interface. The hollow center is ready for the crank spindle." >}}

{{< figure src="/riverside-upgrade/bb-tool-install.jpg" caption="Tightening the bottom bracket cup with a TOOPRE BB wrench. The external splines engage cleanly — no hammering required." >}}

Once the bottom bracket is seated, the crankset slides through and the non-drive arm pinch-bolts lock everything in place:

{{< figure src="/riverside-upgrade/cues-crankset-installed.jpg" caption="Shimano CUES crankset installed — chainring on, chain routed, pedal not yet threaded. The matte black finish matches the fork and stem." >}}
...
{{< figure src="/riverside-upgrade/cues-final.jpg" caption="The finished drivetrain — Shimano CUES crankset with 32T narrow-wide ring, bottle cage back on, and the chain tensioned. Clean and functional." >}}
